...
For background only use: `<div class="bg-[colo_rname]">`
For background and text colors use: `<div class="[color_name]">`
...
<div class="text-secondary">A secondary text color</div>
<!-- buttons -->
